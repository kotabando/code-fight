...
if math.isclose(list_a[1] / list_a[0], list_b[1] / list_b[0]) and math.isclose(list_a[2] / list_a[1], list_b[2] / list_b[1]) and math.isclose(list_a[0] / list_a[2], list_b[0] / list_b[2]):
    print("YES")
else:
    print("NO")